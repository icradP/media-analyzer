...
export { mp4SampleEntryTypeLabel } from "./videoCodecLabels.js";
import { normalizeVideoCodecLabel } from "./videoCodecLabels.js";
...
export function flvMetadataVideoCodecName(codecId) {
    return normalizeVideoCodecLabel(codecId);
}
